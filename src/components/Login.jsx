          ...
          {resetMode ? (
            <>
              <div style={{marginBottom:28}}>
                <div style={{fontSize:22,fontWeight:700,fontFamily:"'Outfit',sans-serif",color:L.t1,letterSpacing:"-.4px",marginBottom:6}}>
                  Redefinir senha
                </div>
              ...
              {resetSent ? (
                ...
                <>
                  ...
                  <button onClick={handleReset} disabled={resetLoading} type="button"
                    style={{width:"100%",padding:"13px",borderRadius:10,fontSize:13,fontWeight:600,
                  ...
                  <button onClick={() => { setResetMode(false); setErr(""); }}
                    style={{width:"100%",fontSize:12,color:L.t3,background:"none",border:`1px solid ${L.line}`,borderRadius:9,
                      padding:"10px",cursor:"pointer",fontFamily:"inherit",transition:"all .15s"}}
                ...
                <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
                  ...
                  <button onClick={() => { setResetMode(true); setResetEmail(email); setErr(""); }}
                    ...
                    style={{fontSize:11,color:L.t1,cursor:"pointer",fontWeight:500,textDecoration:"underline",
                      textUnderlineOffset:3,background:"none",border:"none",fontFamily:"inherit",padding:0}}>
                    Esqueci a senha
                  </button>
                </div>
